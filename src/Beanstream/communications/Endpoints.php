...
class Endpoints {
	 ...
	 */
    CONST BASE_URL_BAMBORANA = 'https://{0}.bam.shift4api.net';
    CONST BASE_URL_BEANSTREAM = 'https://{0}.bam.shift4api.net';  //keeping beanstream endpoint for backwards compatibility when $platform = 'www'
	/**
